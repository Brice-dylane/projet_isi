...
$stm = $pdo->query("select j.id,j.first_name,j.last_name,u.sexe,r.authority_name,u.civilite,u.date_of_bird,u.matricule,u.numero_cni,u.date_delivrance,u.date_expiration,u.nom_etablissement,j.email,u.phone_number 
